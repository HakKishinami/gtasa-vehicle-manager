...
window.I18N_DICTIONARY = {
  en: {
    ...
    "nav.dataCopies": "Data Copies",
    "nav.baseline": "Baseline & Health",
    "nav.readmeLab": "Readme Lab",
    "datacopy.source": "Source:",
    "datacopy.selectFolderTitle": "Select source folder for configuration data",
    "datacopy.btnFind": "Find",
    "datacopy.btnFindTitle": "Find in file (Ctrl+F)",
    "datacopy.btnMaximize": "Maximize",
    "datacopy.btnMaximizeRestore": "Restore",
    "datacopy.btnMaximizeTitle": "Toggle full window view (Esc to restore)",
    "datacopy.findPlaceholder": "Find in file...",
    "datacopy.findPrevTitle": "Previous match (Shift+Enter)",
    "datacopy.findNextTitle": "Next match (Enter)",
    "datacopy.findCloseTitle": "Close search (Esc)",
    "datacopy.noMatches": "No matches",
    "datacopy.matchCount": "{0} of {1}",
    "datacopy.readOnlyBadge": "🔒 Read-Only",
    "datacopy.unsavedBadge": "● Unsaved",
    "datacopy.savedBadge": "✓ Saved",
    "datacopy.btnReload": "Reload",
    "datacopy.btnReloadTitle": "Discard unsaved edits and reload file",
    "datacopy.btnSave": "Save",
    "datacopy.btnSaveTitle": "Save changes (Ctrl+S)",
    "datacopy.fontSizeTitle": "Zoom font size (Ctrl+Wheel or click to cycle)",
    "datacopy.fontSizeZoom": "Font size: {0}px",
    "datacopy.noFiles": "No data configuration files found in this folder",
    "datacopy.confirmUnsaved": "You have unsaved changes in {0}. Do you want to discard them?",
    "datacopy.saveSuccess": "Saved {0} successfully (Backup created).",
    "datacopy.vanillaNote": "Vanilla game data files are strictly protected as read-only.",
    "datacopy.emptyFile": "This file is empty.",
    "datacopy.linesCount": "{0} lines",
    "datacopy.charsCount": "{0} chars",
    ...
    "inspect.btnOpenFolder": "📂 Open Folder",
    "inspect.btnOpenFolderTitle": "Open this mod folder in Windows File Explorer",
    ...
    "inspect.fxtEditEmptyAddon": "Addon vehicles require a display name.",
    "inspect.fxtPlaceholderVanilla": "Leave empty to use vanilla in-game name",
    "inspect.fxtNameRequired": "Enter vehicle name...",
    "toast.fxtRevertedToVanilla": "FXT override removed; reverted to vanilla in-game name.",
    ...
    "install.handlingSharedHint": "Shared handling ID: {0} (shares physics with {0}; no separate handling line will be created).",
    ...
    "install.fxtPlaceholderVanilla": "Leave empty to use vanilla in-game name",
    ...
    "install.statusChecking": "Checking ID...",
    "install.statusDuplicate": "Duplicate ID in this installation",
    "install.statusCheckFailed": "ID check failed — retry",
    "install.tuningBlocked": "{0} part(s) need a valid, conflict-free ID before installation",
    "install.tuningChecking": "Verifying selected tuning part IDs...",
    "install.tuningSelectedSafe": "All selected tuning parts verified conflict-free",
    "install.tuningResolve": "Resolve the highlighted tuning IDs, auto-assign, or uncheck those parts to continue.",
    "install.tuningChanged": "Tuning IDs changed during confirmation. Review them and install again.",
    ...
    "alert.btnOk": "OK",
    "install.ideNotesTitle": "Package data was adjusted",
