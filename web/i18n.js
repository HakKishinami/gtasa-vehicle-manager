...
window.I18N_DICTIONARY = {
  en: {
    ...
    "nav.idPoolTab": "Free ID Analyzer",
    ...
    "inspect.readmePreviewTitle": "📜 Mod Documentation (Readme)",
    ...
    "install.addonReplaceHint": "📦 Addon package installed as a replacement: DFF/TXD are renamed to {1}, and this package's handling, colors, tuning parts and FLA audio replace {0}'s vanilla data. The GXT key below defaults to the target's vanilla key (no IDE override), while the in-game name keeps the package's — so {0} shows up in-game under the mod's name. Edit either field to customize.",
